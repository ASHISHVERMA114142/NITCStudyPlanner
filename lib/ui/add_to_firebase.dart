...
class AddFireBasePage extends StatefulWidget {
  const AddFireBasePage({Key? key}) : super(key: key);

  @override
  State<AddFireBasePage> createState() => _AddFireBasePageState();
}

class _AddFireBasePageState extends State<AddFireBasePage> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text("Add Task ",
              style: HeadingStyle,),
               MyInputField(title: "Enrollment code",hint: "Enter your Enrollment code",controller: _enrollController,),
  ...
  _validateData(){
    if(_titleController.text.isNotEmpty && _noteController.text.isNotEmpty && _enrollController.text.isNotEmpty){
      _addTaskToDB();
      Get.back();
  ...
  _addTaskToDB() async {
      ...
      enrollment_code : _enrollController.text,
